function [varargout] = gp_ins(hyp, inf, mean, cov, lik, T,N,sign,x,y,DX2)
...
try                                                  % call the inference method
    ...
    if nargout<=1
        [nlZ] = inf(hyp, mean, cov, lik, x, y,T,N,sign,x,y,DX2); dnlZ = {};
    else
        [nlZ dnlZ] = inf(hyp, mean, cov, lik,T,N,sign, x, y,DX2);
    end
catch
    msgstr = lasterr;
