function [varargout] = gp_delayIns(hyp, inf, mean, cov, lik, T,N,p,sign,x, y,DX2)
...
try                                                  % call the inference method
    ...
    if nargout<=1
        [nlZ] = inf(hyp, mean, cov, lik, x, y,T,N,p,sign,x,y,DX2); dnlZ = {};
    else
        [nlZ dnlZ] = inf(hyp, mean, cov, lik,T,N,p,sign, x, y,DX2);
    end
catch
    msgstr = lasterr;
