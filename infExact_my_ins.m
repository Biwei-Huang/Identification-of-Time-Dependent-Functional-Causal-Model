function [nlZ dnlZ nlhood posterior_mean posterior_covariance] = infExact_my_ins(hyp, mean, cov, lik, T,N,p,sign,x,y,DX,X0)
...
if(sign)
    ...
    posterior_covariance=K_extend-(DX*K_extend)'*(K_total_inv/sl)*(DX*K_extend);
